...
if(empty($id=$_GET['id']) AND empty($id_muzakki=$_GET['id_muzakki'])){
	echo "id kosong";
}else{
...
if(isset($_POST['submit'])){
		...
		if(updatepesan($id,$id_muzakki,$balasan,$status)){
...
<?php while ($a=mysqli_fetch_assoc($result)) { ?>
  ...
  <div class="form-group">
    ...
    <input readonly type="text" class="form-control" value="<?= $a['nama_muzakki'];?>">
  </div>
  <div class="form-group">
    <label >Pesan</label>
