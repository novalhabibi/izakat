...
$id_muzakki=pengkodean("muzakki","MZ");
              ...
              if($password === $password_confirm){
                $password=sha1($password);
                        ...
                        // if($kode===$_SESSION["Captcha"]){
                            ...
                            if(simpanpendaftaranmuzakki($id_muzakki,$nama,$email,$password,$alamat,$tgl_daftar,$no_telp)){
...
<form class="form-horizontal" role="form" method="post" action="">
  <input type="hidden" name="id_muzakki" value="<?php echo $id_muzakki ?>">
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Nama Muzakki</label>
    <div class="col-sm-10">
