...
if(empty($_SESSION['id_muzakki'])){ 
  echo "<script>document.location.href = 'login.php';</script>";
}else{

if(isset($_POST['bayar'])){
  $notransaksi=$_POST['notransaksi'];
$id_muzakki=$_SESSION['id_muzakki'];
$id_transaksi=pengkodean("transaksi",$id_muzakki);
...
/*
   ...
   */         
            if(simpantransaksi($id_transaksi,$id_muzakki,$notransaksi,$nama_muzakki,$jeniszakat,$jumlahbayar,$status)){
...
<div class="page-header">
  <h1>Bayar Zakat</h1>
        ...
        <div class="form-group">
          <label>Nama</label>
          <input type="text" class="form-control" name="nama_muzakki" value="<?php echo $_SESSION['nama_muzakki'];?>" readonly>
        </div>
