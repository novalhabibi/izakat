...
if(isset($_POST['submit'])){
 ...
 if(!empty($nama)){
      ...
      if(editprofil($namalengkap,$email,$alamat,$notlp,$id_muzakki)){
                echo "<script>document.location.href = 'profil.php';</script>";
            }else{
      ...
      <div class="col-md-8">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <table class="table table-bordered">
            <input type="hidden" name="id_muzakki" value="<?php echo $row['id_muzakki'] ?>">
                      <tr>
                        <td>Foto Profil</td>
                      ...
                      <tr>
                        <td>Nama Lengkap</td>
                        <td><input name="nama" class="form-control" type="text" value="<?= $row['nama_muzakki'];?>"></td>
                      </tr>
                      <tr>
                        <td>Email</td>
