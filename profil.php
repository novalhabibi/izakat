  			...
  			<div class="panel-body">
				...
				<div class="col-md-9">
					...
					<p><span class="glyphicon glyphicon-earphone"></span> +<?= $row['no_tlp'];?></p>
						<a href="editprofile.php?no=<?= $row['id_muzakki'];?>"><button type="submit" name="edit" class="btn btn-success"><span class="glyphicon glyphicon-cog"></span> Edit Profil</button></a>
